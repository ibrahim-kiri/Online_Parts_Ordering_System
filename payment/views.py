...
from store.models import Part, Profile
import datetime
# Import Paypal
...
def billing_info(request):
    if request.POST:
        ...
        if request.user.is_authenticated:
            ...
            return render(request, "payment/billing_info.html", {"paypal_form":paypal_form, "cart_parts":cart_parts, "quantities":quantities, "totals":totals, "shipping_info":request.POST, "billing_form":billing_form})
        else:
            # Not logged in
            # Get The Billing Form
            billing_form = PaymentForm()
...
def checkout(request):
    ...
    if request.user.is_authenticated:
        ...
        return render(request, "payment/checkout.html", {"cart_parts":cart_parts, "quantities":quantities, "totals":totals, "shipping_form":shipping_form})
    else:
        # Checkout as guest
